...
fit <- gam(list(as.matrix(log(dat['story_1_sdrX'])) ~ s(lnIM, k=6) + s(magnitude, k=6) ,
                ...
                as.matrix(log(dat['story_3_sdrX'])) ~ s(lnIM, k=6) + s(magnitude, k=6) ,
                as.matrix(log(dat['story_3_sdrZ'])) ~ s(lnIM, k=6) + s(magnitude, k=6) ,
                as.matrix(log(dat['story_3_pfaX'])) ~ s(lnIM, k=6) + s(magnitude, k=6),
                as.matrix(log(dat['story_3_pfaZ'])) ~ s(lnIM, k=6) + s(magnitude, k=6),
                as.matrix(log(dat['story_4_sdrX'])) ~ s(lnIM, k=6) + s(magnitude, k=6) ,
                as.matrix(log(dat['story_4_sdrZ'])) ~ s(lnIM, k=6) + s(magnitude, k=6) , 
                as.matrix(log(dat['story_4_pfaX'])) ~ s(lnIM, k=6) + s(magnitude, k=6),
                as.matrix(log(dat['story_4_pfaZ'])) ~ s(lnIM, k=6) + s(magnitude, k=6)
                ),
                family = mvn(d = 16))
summary(fit)
```
...
fit <- gam(list(as.matrix(log(dat['story_1_sdrX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_1_sdrZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_1_pfaX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_1_pfaZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_2_sdrX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_2_sdrZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_2_pfaX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_2_pfaZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_3_sdrX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_3_sdrZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_3_pfaX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_3_pfaZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_4_sdrX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_4_sdrZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6), 
                as.matrix(log(dat['story_4_pfaX'])) ~ s(lnIM, k=6) + s(Rjb, k=6),
                as.matrix(log(dat['story_4_pfaZ'])) ~ s(lnIM, k=6) + s(Rjb, k=6)
                ),
                family = mvn(d = 16))
summary(fit)
```
