...
def compile_kl_divergence(BuildingList, building_Index, baseDir, IM_List, df_IMs, pairingID = 1,
...
def summarize_agg_kld(BuildingList, baseDir, IM_List, df_IMs, pairingID = 1,
                          numGM = 826, remove_collapse = False, KL_on_residual=False,
                         use_predicted_IM=False, mv_causal_params=False):
    d = {}

    for idx in range(len(BuildingList)):
        tempdf = compile_kl_divergence(BuildingList, idx, baseDir, IM_List, df_IMs, pairingID = pairingID,
